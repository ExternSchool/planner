...
@Autowired
    private SchoolSubjectServiceImpl subjectService;
    ...
    public String showSubjects(Map<String, Object> model) {
        Iterable<SchoolSubject> subjects = this.subjectService.findAll();
        model.put("subjects", subjects);
        return "subject";
    }

    @RequestMapping(value = "{id}", method = RequestMethod.DELETE)
    public ResponseEntity<Void> delete(@RequestParam SchoolSubject subject, @PathVariable("id") Long id) {
