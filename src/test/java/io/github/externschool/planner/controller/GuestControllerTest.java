...
public class GuestControllerTest {
    ...
    public void setup(){
        ...
        map.add("verificationKeyValue", personDTO.getVerificationKeyValue());
    ...
    @Test
    @WithMockUser(username = userName, roles = "GUEST")
    public void shouldReturnFormBack_whenPostUpdateActionSaveWithInvalidKey() throws Exception {
        map.remove("verificationKeyValue");
        map.add("verificationKeyValue", "123");
        mockMvc.perform(post("/guest/update")
                .param("action", "save")
                .params(map))
                .andExpect(status().isOk())
    ...
    @Test
    @WithMockUser(username = userName, roles = "GUEST")
    public void shouldReturnFormBack_whenPostUpdateActionSaveWithEmptyField() throws Exception {
